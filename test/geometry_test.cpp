...
TEST(GeometryTest, lines_intersect) {
    ...
    const auto l1 = geometry::line2{vec2{-5, -5}, vec2{5, 5}};
    const auto l2 = geometry::line2{vec2{-5, 5}, vec2{5, -5}};
    const auto intersection = geometry::intersection(l1, l2);
    const auto has_intersection = geometry::has_intersection(l1, l2);

    ASSERT_TRUE(intersection.has_value());
    ASSERT_TRUE(has_intersection);
...
TEST(GeometryTest, lines_intersect_2) {
    ...
    const auto l1 = geometry::line2{vec2{0, 1}, vec2{1, 0}};
    const auto l2 = geometry::line2{vec2{0, 0}, vec2{1, 1}};
    const auto intersection = geometry::intersection(l1, l2);
    const auto has_intersection = geometry::has_intersection(l1, l2);
...
TEST(GeometryTest, lines_dont_intersect_1) {
    const auto l1 = geometry::line2{vec2{-10, -10}, vec2{-5, -5}};
    const auto l2 = geometry::line2{vec2{-5, 5}, vec2{5, -5}};
    const auto intersection = geometry::intersection(l1, l2);
    const auto has_intersection = geometry::has_intersection(l1, l2);

    ASSERT_FALSE(has_intersection);
    ASSERT_FALSE(intersection.has_value());
}

TEST(GeometryTest, lines_dont_intersect_2) {
    const auto l1 = geometry::line2{vec2{-5, 5}, vec2{5, -5}};
    const auto l2 = geometry::line2{vec2{-10, -10}, vec2{-5, -5}};
    const auto intersection = geometry::intersection(l1, l2);
    const auto has_intersection = geometry::has_intersection(l1, l2);
...
TEST(GeometryTest, lines_dont_intersect_3) {
    const auto l1 = geometry::line2{vec2{-5, -5}, vec2{0, 0}};
    const auto l2 = geometry::line2{vec2{-1, -1}, vec2{5, 5}};
    const auto intersection = geometry::intersection(l1, l2);
    const auto has_intersection = geometry::has_intersection(l1, l2);
